 ...
 * como spring.jpa.open-in-view=false, um relacionamento LAZY quebraria
 * (LazyInitializationException) na hora do RequisicaoResponse tentar ler
 * getInstituicaoSolicitante() fora da transacao do Service.
 */
@Entity
...
public class Requisicao {
    ...
    public Instituicao getInstituicaoSolicitante() { return instituicaoSolicitante; }
    ...
    public TipoComponente getComponente() { return componente; }
